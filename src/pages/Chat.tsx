...
function Chat() {
  ...
  return (
    ...
    <form onSubmit={sendMsg}>
      <input id='chatinput' className='mx-5 w-[96vw] bg-neutral-900 p-3 rounded mt-5' type="text" value={value} onChange={e => setValue(e.target.value)} placeholder='send a message'/>
    </form>
    </div>
  )
}
